...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>EDUBRELLA - MY ACCOUNT(Teacher)</title>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="my-account-teacher.php" class="nav-item nav-link active">My Account</a>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <div class="row">
									...
									<div class="col-md-6">
                                        <Select class="form-control" type="text" placeholder="Medium" multiple>
                                            <Option value = "English" SELECTED>English</Option>
                                            <Option value = "Sinhala" SELECTED>Sinhala</Option>
                                            <Option value = "Tamil">Tamil</Option>
                                        </Select>
										<p style="font-size:14px">Hold down the Ctrl (windows) or Command (Mac) button to select multiple options.</P>
                                    </div>
                                    <div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-12">
                                        <button class="btn">Update Grades</button>
                                        <br><br>
                                    </div>
									</div>
									<fieldset style="display:inline-flex">
										<legend>Subjects</legend>
										<label class="container" style="display:inline-block;position: relative">
									...
									<div class="row">
										<div class="col-md-12">
                                        <button class="btn">Update Subjects</button>
                                        <br><br>
                                    </div>
									</div>
									<div class="row">
										<textarea placeholder="Qaulification and Experiance" rows="5" cols="120"style="margin-bottom:10px;margin-left:15px"></textarea>
										<p>
										<div class="col-md-12">
                                        <button class="btn">Upadate Detaills</button>
                                        <br><br>
                                    </div>
									</div>
