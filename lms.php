...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="lms.php" class="nav-item nav-link active">LMS</a>
        ...
        <!-- Product List End -->
                            ...
                            <div class="tab-pane fade" id="notifications" role="tabpanel" aria-labelledby="payment-nav">
                                <h4>Notification</h4>
                                <p>
                                    No notifications
                                </p> 
