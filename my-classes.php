...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>EDUBRELLA - MY CLASSES</title>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="my-classes.php" class="nav-item nav-link active">My Classes</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    <div class="dropdown-toggle" data-toggle="dropdown">Sort by grade</div>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" class="dropdown-item">Grade 1-5</a>
                                                        <a href="#" class="dropdown-item">Grade 6</a>
                                                        <a href="#" class="dropdown-item">Grade 7</a>
                                                        <a href="#" class="dropdown-item">Grade 8</a>
                                                        <a href="#" class="dropdown-item">Grade 9</a>
                                                        <a href="#" class="dropdown-item">Grade 10</a>
                                                        <a href="#" class="dropdown-item">Grade 11</a>
                                                        <a href="#" class="dropdown-item">Grade 12</a>
                                                        <a href="#" class="dropdown-item">Grade 13</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="product-price-range">
                                                <div class="dropdown">
                                                    <div class="dropdown-toggle" data-toggle="dropdown">Sort by sujects</div>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" class="dropdown-item">Science</a>
                                                        <a href="#" class="dropdown-item">Mathamatics</a>
                                                        <a href="#" class="dropdown-item">Sinhala</a>
                                                        <a href="#" class="dropdown-item">English</a>
                                                        <a href="#" class="dropdown-item">Biology</a>
                                                        <a href="#" class="dropdown-item">Chemestry</a>
                                ...
                                <div class="col-md-12">
                                    <div class="cart-summary">
                                        <div class="cart-content">
                                            <h1>Classes</h1>
                                            <p>Classes attending<span>2</span></p>
                                            <h2>Total fee<span>$#</span></h2>
                                        </div>
